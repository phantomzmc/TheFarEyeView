...
public class Park3 extends AppCompatActivity {
    private ViewPager pager;
    private int[] image = {R.drawable.aop, R.drawable.aop2};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText(R.string.t_park3);
        TextView detail = (TextView) findViewById(R.id.textView2);
        detail.setText(R.string.d_park3);
