...
public class MyService2 extends Service{
    ...
    String text1 = "กำลังเข้าสู่เมืองสุโขทัย";


    @Override
    public int onStartCommand(Intent intent, int flags, int startId) {
        NotificationCompat.Builder notification = new NotificationCompat.Builder(MyService2.this);
        ...
        bigPictureStyle.bigPicture(BitmapFactory.decodeResource(this.getResources(), R.drawable.noti_pic1));
        bigPictureStyle.setBigContentTitle(text1);
        notification.setStyle(bigPictureStyle);


        Intent i = new Intent(MyService2.this, MainActivityList2.class);
        TaskStackBuilder builder = TaskStackBuilder.create(MyService2.this);
